...
public class BloomHashTestHGW {
	...
	String firstName = "hier";
	String lastName = "eintragen";
	char gender = 'f';
	int birthYear = 1995;
	int birthMonth = 12;
	int birthDay = 21;
	...
	String expected;
	// first line is the result for real values with the seeds from the confluence
	// page
	...
	// the second line is for seed=0 uncomment next line, if
	// BloomHashFactory.properties contains real values
	assertTrue(actual.length() == 336);
	assertEquals(expected, actual);
    }
