...
import io.github.dway17.codex_bloom.BloomHash.ChangeCase;
...
class BloomHashNormalizeTest {
	...
	void test() {
		...
		trans.put("é", "e");
		String actual = bh.normalize(ChangeCase.UPPER, s, voc, remSet, trans);
	...
	void testNormalizeReplaceNullTransNull() {
		...
		String s = "az";
		String voc = "AZ";
		String actual = bh.normalize(ChangeCase.UPPER, s, voc, null, null);
		String expected = "AZ";
		assertEquals(expected, actual);
	}
	...
	void testNormalizeTransNull() {
		...
		Set<String> remSet = new HashSet();
		remSet.add("Prof.");
		String actual = bh.normalize(ChangeCase.UPPER, s, voc, remSet, null);
		String expected = "AZ";
		assertEquals(expected, actual);
	}
